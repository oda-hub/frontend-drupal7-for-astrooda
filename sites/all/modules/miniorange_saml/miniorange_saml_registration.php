...
function register_data($transaction_limit=false, $invalid_credential=false, $invalid_email = false){
                ...
                <div class="modal-dialog" style="width: 500px;">
                    <div class="modal-content popup" style="border-radius: 20px;">
                        	<?php if($transaction_limit == true){ ?>
                                <p style="color: red;font-size: 11px;">An error has been occured. Please try after some time or contact us at <a href="mailto:drupalsupport@xecurify.com">drupalsupport@xecurify.com</a>.</p>
                            <?php }elseif($invalid_credential == true){ ?>
                                <p style="color: red;font-size: 11px;text-align: center;">Invalid Credentials!</p>
                            <?php }elseif($invalid_email == true){ ?>
                                <p style="color: red;font-size: 11px;text-align: center;">You may have entered an invalid Email-Id (We discourage the use of disposable emails)</p>
                            <?php }else { ?>
                            ...
                            <?php } ?>
                            <h2 class="popup-header">Register/Login with miniOrange</h2>
...
function miniorange_otp($wrong_otp=false, $resend_otp=false, $resend_limit=false){
    	$b_url = Utilities::miniorange_get_baseURL();
        $close_url = $b_url . '/?q=close_registration';
		$myArray = array();
        $myArray = $_POST;
                            ...
                            <form name="ff" method="post" action="" id="mo_otp_verify">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <form name="f" method="post" action="" id="mo_otp_resend">
                                            ...
                                            <a type="button" href=<?php echo $close_url ?> class="btn btn-default" >Cancel</a>
                                        </form>
                                    </div>
                        </div>
                    </div>
    ...
    <html>
        ...
        <body>
            <script type="text/javascript">
                  ...
                  var x = window.open("<?php echo $redirectUrl; ?>", "Upgrade");
                  if (x == null) {

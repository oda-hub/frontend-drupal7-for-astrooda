...
$options['structure-tables']['mmoda'] = array_merge($options['structure-tables']['common'],
	array('ctools_css_cache', 'ctools_object_cache', 'logz', 'views_object_cache', 'authmap',
	      'openid_*', 'webform_submissions', 'webform_submitted_data'
)
);

$options['skip-tables']['mmoda'] = array(
    '*_mtm_tmp', 'mmoda_variable_defaults'
);

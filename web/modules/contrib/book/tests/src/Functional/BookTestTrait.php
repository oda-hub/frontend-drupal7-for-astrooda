...
trait BookTestTrait {
   ...
   */
  public function checkBookNode(EntityInterface $node, array|null $nodes, EntityInterface|bool $previous, EntityInterface|bool $up, EntityInterface|bool $next, array $breadcrumb) {

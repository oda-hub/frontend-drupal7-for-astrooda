...
class EntityContentExportSettings extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['delete_exported_file'] = [
      '#type' => 'checkbox',
      '#title' => $this->t('Delete Exported File'),
      '#description' => $this->t('If checked the downloaded file will be deleted
        after a successful download.'),
      '#default_value' => $this->getElementPropertyValue(
        'delete_exported_file', $form_state
      )
    ];
  ...
  protected function getEntityViewDisplayOptions($entity_type, $bundle, array $exclude_modes = array()) {
    ...
    foreach ($this->getEntityViewDisplay($entity_type, $bundle) as $display) {
